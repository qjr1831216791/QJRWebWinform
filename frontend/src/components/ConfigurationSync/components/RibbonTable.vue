                    ...
                    <el-table :height="tableHeight" :data="tableData.ecFrom" :key="tableKey + '_envirFrom'" border
                        ...
                        <el-table-column type="expand">
                            <template slot-scope="props">
                                <el-table :data="props.row.detail" border :default-sort="{
                                    prop: 'new_roleid',
                                    order: 'ascending',
                                }" style="width: 100%">
                                    <!-- 行号 -->
                                    ...
                                    <!-- 安全角色 -->
                                    <el-table-column prop="new_roleid" label="安全角色" show-overflow-tooltip>
                                    </el-table-column>
                                </el-table>
                            </template>
                        </el-table-column>
                        ...
                        <!-- 按钮名称 -->
                        <el-table-column prop="new_name" label="按钮名称" sortable show-overflow-tooltip>
                        </el-table-column>
                        <!-- 重复记录提示信息 -->
                        <el-table-column prop="new_desc" label="描述" show-overflow-tooltip>
                        </el-table-column>
                    </el-table>
                </div>
            </el-card>
